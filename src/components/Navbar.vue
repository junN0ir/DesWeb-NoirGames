<template>
  <nav class="bg-[#03051A] text-white px-6 md:px-10 py-4 flex justify-between items-center shadow relative">
    ...
    <ul class="hidden md:flex gap-10 text-lg font-medium">
      ...
      <li>
        <router-link to="/game" class="hover:text-yellow-300 transition">
          Game
        </router-link>
      </li>
      <li>
        <router-link to="/cek-pesanan" class="hover:text-yellow-300 transition">
          Cek Pesanan
        </router-link>
      </li>
      <li>
        <router-link to="/ulasan" class="hover:text-yellow-300 transition">
          Ulasan
        </router-link>
      </li>
      <li>
        ...
        <ul class="flex flex-col gap-6 text-lg font-medium">
          <li>
            <router-link 
              to="/" 
              @click="closeMenu"
              class="block py-2 hover:text-yellow-300 transition"
            >
              Beranda
            </router-link>
          </li>
